            ...
            <div className="search-bar-top">
              <div className="search-bar">
                <select className="nice-select">
                  <option data-display="Select" className="option" selected={true}>{t('all_category')}</option>
                  <option className="option">watch</option>
                  <option className="option">mobile</option>
                  <option className="option">kid’s item</option>
                </select>
                <form>
                  <input name="search" placeholder={t('search_product')} type="search" />
